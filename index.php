    ...
    <div class="content inner">
                ...
                <nav class="drawer-nav sidebar-nav">
                    <div class="nav-inner">
                        ...
                        <div class="sidebar-logo">
                            <a href="<?php echo home_url(); ?>"><img class="profile-img" src="<?php echo get_template_directory_uri(); ?>/img/profile.JPG" alt="プロフィール画像"></a>
                        </div>
        ...
        <div class="main">
            ...
            <div class="blog">
                ...
                <?php while (have_posts()): the_post(); ?> <!-- 記事を読み込む際に必要 ループさせる -->
    
                    <li class="blog-list fadeInUpTriggerOnce">

                            <div class="blog-data">
                                <p class="blog-time"><?php the_time("Y/n/d"); ?></p>
                                <dl class="blog-category">
                                    <dt class="blog-category-title">カテゴリー：</dt>
                                    <?php
                                        $categories = get_the_category();

                                        foreach( $categories as $category ) {
                                            echo '<dd class="blog-category-name"><a href="'.get_category_link($category->term_id).'">'.$category->name.'</a></dd>';
                                        }   
                                    ?>
                                </dl>
                            </div>   
                        ...
                        <a  href="<?php the_permalink(); ?>">
                            ...
                            <div class="blog-img">
                                ...
                                <?php if(has_post_thumbnail()): ?>
                                    <figure><img src="<?php the_post_thumbnail_url(); ?>" alt="<?php get_the_title(); ?>"></figure>
                                <?php endif; ?><!-- アイキャッチ画像表示 -->

                            </div>
                            
                            <div class="blog-content">
                                <?php the_excerpt(); ?><!-- 記事本文(抜粋) -->
                            </div>
                        </a>
